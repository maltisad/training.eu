                      ...
                      <tbody>
                        ...
                        <tr>
                                ...
                                <td>{{$course->start_date}}</td>
                                 <td>{{$course->teacher->emri}}</td>
                                <td><img src="{{asset('uploads/course/'.$course->image)}}"></td>
                       
                         
                          <td>
                            <label class="badge badge-danger"><a href="/addcourse/delete/{{$course->id}}">Delete </a></label>

                             <label class="badge"><a href="/addcourse/edit/{{$course->id}}">View/Edit </a></label>
                          </td>
                        </tr>
                         @endforeach
                      </tbody>
