          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="probootstrap-service-2 probootstrap-animate">
                 <div class="image">
                  <div class="image-bg">
                   <img src="{{ asset('uploads/course/' . $course->image) }}"   class="img-responsive">
                  </div>
                </div>
                ...
                <div class="text">
                  ...
                  <p><a href="/enroll/{{$course->id}}" class="btn btn-primary">Enroll now</a> <span class="enrolled-count">2,928 students enrolled</span></p>
                </div>    
              </div>
            </div>
              @endforeach
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="probootstrap-teacher text-center probootstrap-animate">
                <figure class="media">
                  <img src="{{ asset('uploads/teacher/' . $teacher->image) }}"   class="img-responsive">
                
                </figure>
                <div class="text">
                  <h3>{{$teacher->emri}}   {{$teacher->mbiemri}}</h3>
                  <p>{{$teacher->titulli}}</p>
